...
const data = {
  ...
  alarm_bells: [
    { position: 1,  title: 'Belang',                  subtitle: 'Wil iemand iets van jou?',               duration_min: 4, has_vote_round: true, expert_slug: 'ili-ma',              color: { solid: '#FF6B35', from: '#FF9A6C',  to: '#FF6B35' }, illustration: 'illustrations/belang.png' },
    ...
    { position: 3,  title: 'Herkomst',               subtitle: 'Van wie komt deze informatie?',           duration_min: 4, has_vote_round: true, expert_slug: 'alexander-pleijter', color: { solid: '#B594F7', from: '#B594F7', to: '#8B6FE0' }, illustration: 'illustrations/herkomst.png' },
